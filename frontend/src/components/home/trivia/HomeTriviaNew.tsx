    ...
    <section className="pb-20 sm:pb-24" aria-labelledby="home-trivia-title">
      <div className="page-wrapper ">
        <div className="relative overflow-hidden rounded-card bg-[#C2E6FE]">
          ...
          />
          <GrassBg
            className="pointer-events-none absolute inset-x-0 -bottom-24 h-auto w-full"
            aria-hidden="true"
          />
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-5  rounded-card border px-12 py-6">
            {/* 1st Column */}
              ...
              <div className="flex item-center flex-col gap-3">
                ...
                <div>
                  <h2
                    ...
                    className="mt-2 text-2xl font-semibold text-[#2D2F27]"
                  >
                    A quick trail break?
                  </h2>
                  <p className="mt-2 max-w-sm text-sm font-medium leading-5 text-[#2D2F27]">
                  ...
                  {TREK_QUIZZES.map((trek, index) => {
                    ...
                    return (
                      <button
                        ...
                        className={`group flex shrink-0 flex-col items-center transition-all duration-300 ease-out hover:scale-110 hover:drop-shadow-[0_8px_12px_rgba(38,60,46,0.2)] focus-visible:scale-110 ${index % 2 === 0 ? '-translate-y-2' : 'translate-y-2'}`}
                      ...
                      >
                        ...
                        <span className="relative -mt-3 rounded-full bg-white px-3 py-1 text-base font-semibold text-[#40504a] shadow-sm transition-all duration-300 group-hover:-translate-y-0.5 group-hover:bg-[#faffee] group-hover:text-[#5f7c0d] sm:text-lg lg:text-sm">
                          {trek.label}
                        </span>
                      </button>
                    );
            ...
            <div>
              <div className="relative flex flex-col items-end">
                <p className="self-start text-sm font-semibold text-[#5F7C0D]">
                  Take a general test
                </p>
                <Arrow
                  className="pointer-events-none absolute left-[20%] top-1/4 text-[#526e00]"
                  aria-hidden="true"
                />
                <button
                  type="button"
                  onClick={playGeneralQuiz}
                  className="mt-14 rounded-xl bg-[#88b112] px-7 py-3 text-sm font-medium text-white transition hover:bg-[#789f00] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#526e00] sm:text-base"
                >
                  Play Trivia
                </button>
              </div>
