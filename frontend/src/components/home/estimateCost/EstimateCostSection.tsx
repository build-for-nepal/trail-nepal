...
export default function EstimateCostSection() {
  ...
  return (
    <>
      <section className="relative bg-[url('/images/ESbg.png')] bg-lightgray bg-center bg-cover bg-no-repeat">
        <div className="absolute inset-0 bg-black/10" aria-hidden="true" />

        <div className="relative z-10 flex w-full flex-col items-center px-6 py-16 gap-[60px] lg:px-[80px] lg:py-24">
