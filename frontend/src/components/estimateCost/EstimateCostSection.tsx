...
export default function EstimateCostSection() {
  ...
  return (
    <section className="bg-[url('/images/ESbg.png')] bg-lightgray bg-center bg-cover bg-no-repeat">
      <div className="absolute inset-0 bg-black/40" aria-hidden="true" />

      <div className="relative z-10 flex w-full flex-col items-center px-6 pb-[60px] pt-[80px] gap-[60px] lg:min-h-[1079px] lg:px-[80px] lg:pb-[200px] lg:pt-[100px]">
        <SectionHeader
          title="Estimate Cost"
