  ...
  'gokyo-valley-trek': {
    ...
    gearChecklist: {
      essentials: [
        ...
        {
          item: 'Personal First Aid Kit & Altitude Meds (Diamox)',
          weight: '0.35kg',
        },
        { item: 'Trekking Poles with Snow Baskets', weight: '0.5kg' },
        {
          item: 'Headtorch + Spare Batteries (for Gokyo Ri pre-dawn)',
          weight: '0.15kg',
        },
      ],
      optional: [
        {
          item: 'Lightweight Crampons or Microspikes (for icy Gokyo Ri trail)',
          weight: '0.4kg',
        },
        { item: 'Fleece Mid-Layer', weight: '0.5kg' },
        {
          item: 'Buff / Balaclava (essential above Machhermo at night)',
          weight: '0.08kg',
        },
        {
          item: 'Portable Power Bank (solar charging unreliable above Dole)',
          weight: '0.3kg',
        },
  ...
  'ghorepani-poon-hill-trek': {
    ...
    gearChecklist: {
      essentials: [
        ...
        {
          item: 'Headtorch with Fresh Batteries (for Poon Hill pre-dawn)',
          weight: '0.15kg',
        },
      ],
      optional: [
        {
          item: 'Trekking Poles (helpful on Ulleri & Ghandruk descent)',
          weight: '0.5kg',
        },
        {
          item: 'Windchill Layer / Softshell (for Poon Hill ridge)',
          weight: '0.35kg',
        },
  ...
  'mardi-himal-trek': {
    ...
    gearChecklist: {
      essentials: [
        ...
        {
          item: 'Trekking Poles (Essential Above Upper Camp)',
          weight: '0.5kg',
        },
      ],
      optional: [
