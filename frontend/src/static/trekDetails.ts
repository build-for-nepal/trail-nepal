  ...
  "ebc-trek": {
    ...
    timeline: [
      ...
      },
      {
        ...
        description:
          "You bid farewell to the mountains with one last scenic flight back to Kathmandu. As the small plane lifts off from the short runway, you can look out the window at the massive peaks you just spent two weeks exploring. Upon arrival in Kathmandu, you will be transferred to your hotel.",
        accommodations: [],
      ...
      },
      {
        ...
        description:
          "Flights in and out of Lukla are highly dependent on weather conditions and can often be delayed or canceled due to fog or high winds. This day is built into the itinerary as a safety net. If your flight is on time, this day can be used for sightseeing in the Kathmandu Valley.",
        accommodations: [],
      ...
      },
      {
        ...
        description:
          "Your Himalayan journey comes to an end today. A representative will pick you up from your hotel and drive you to Tribhuvan International Airport for your flight home. As you fly away, you carry with you the memories of the world's highest peaks.",
        accommodations: [],
